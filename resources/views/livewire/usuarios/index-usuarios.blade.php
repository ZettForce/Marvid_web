<div wire:init="cargando">
    {{-- <div wire:poll> funciona para recargar pagina en tiempo real--}}
      ...
      <a type="button" href="{{route('crear.usuarios')}}" class="float-right mb-3 btn btn-success">Agregar <i class="fa fa-plus" aria-hidden="true"></i></a>
      ...
      <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('mostrar.usuarios',$usuario)}}" title="Ver más" class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
                    <a href="{{route('editar.usuarios',$usuario)}}" title="Editar" class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></i></a>
                    <a href="{{route('borrar.usuarios',$usuario)}}" title="Eliminar" class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true"></i></a>
                </td>
              </tr>
